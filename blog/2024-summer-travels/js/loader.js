const STATE = {
    ...
    'quebec': {
        ...
        As I arrived in Québec, tiny things started to go right to ease my nervousness. First off, I was living in such a lucky middlespot between Université Laval and Vieux Québec. My hosts were kind enough to lend me their bike, so I biked everywhere. **Every destination had a journey of literal effort behind it. It made me appreciate each expedition that much more**. I was especially lucky that Ghislain and Brigitte lived right on a bike-only road. So I'd just explore \- start riding in one direction to see how far the road went and then do the same in the other.   
        ...
        <figcaption>Pont de Québec to the East. It's nice to bike to next to the river :-)</figcaption> 
        ...
        That said, I also stopped at the Huron-Wendat museum while I was to the north of Charlesbourg. I forced myself to get the French tour even though I was nervous. I couldn't understand how rapidly my guide Daphné spoke at first. Surprisingly, I got used to it after a while! 
        ...
        <figcaption>Awkward photo at La Citadelle de Québec because the tour guide was waiting on <i>only</i> me &#128128;</figcaption>
        ...
        Brigitte was very mothering since they also had their own daughters just ten years older than me. Ghislain was the most 30-year-old-seeming 60-year-old you've never met in your life 😮 I was a developer and he worked in business. So I'd try to simplify what I did when describing my work to him. Then, he'd surprise me by talking about failures in cryptographic security with the advent of quantum computers and I'd be like :OOOOO
